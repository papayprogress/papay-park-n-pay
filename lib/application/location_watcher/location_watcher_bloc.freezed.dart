...
mixin _$LocationWatcherEvent {
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(Either<LocationFailure, List<Location>> failureOrNotes)?
        locationReceived,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$_LocationReceivedCopyWith<$Res> {
  ...
  $Res call({Either<LocationFailure, List<Location>> failureOrNotes});
}
...
class _$_LocationReceived implements _LocationReceived {
  const _$_LocationReceived(this.failureOrNotes);

  @override
  final Either<LocationFailure, List<Location>> failureOrNotes;

  @override
  String toString() {
    return 'LocationWatcherEvent.locationReceived(failureOrNotes: $failureOrNotes)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return locationReceived(failureOrNotes);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return locationReceived?.call(failureOrNotes);
  }
...
abstract class _LocationReceived implements LocationWatcherEvent {
  ...
  Either<LocationFailure, List<Location>> get failureOrNotes =>
      throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  _$$_LocationReceivedCopyWith<_$_LocationReceived> get copyWith =>
      throw _privateConstructorUsedError;
